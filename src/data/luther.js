// Comentarios bíblicos de Martín Lutero (1483–1546)
// Fuentes principales:
//   - "Comentario a la Epístola a los Gálatas" (Commentarius in Epistolam Pauli ad Galatas, 1535)
//   - "Prefacio a la Epístola a los Romanos" (Vorrede auf die Epistel S. Pauli an die Römer, 1522)
//   - "Comentario a los Salmos" (Operationes in Psalmos, 1519–1521)
//   - "Catecismo Mayor" (Der Große Katechismus, 1529)
//   - "De la libertad del cristiano" (Von der Freiheit eines Christenmenschen, 1520)
//   - "Conversaciones de Sobremesa" (Tischreden, 1531–1546)
// Obras de dominio público — disponibles en Project Gutenberg y CCEL

export const LUTHER_COMMENTARY = [

  {
    ref: 'Génesis 3:15',
    titulo: 'El Protoevangelio: la primera promesa del Evangelio',
    texto: 'Lutero llamó a este versículo "el evangelio en germen": la primera proclamación de la redención en toda la Biblia. La "simiente de la mujer" que aplastaría la cabeza de la serpiente es Cristo mismo, nacido de mujer sin varón (Gálatas 4:4). Lutero veía en este versículo la prueba de que el evangelio no es invento cristiano tardío sino la promesa más antigua de Dios al ser humano caído. Adán y Eva murieron creyendo en esta promesa —murieron en la fe, antes de que la promesa se cumpliera visiblemente. Toda la historia del Antiguo Testamento es el desarrollo de esta promesa: Abraham, Moisés, David, los profetas —todos vivieron de ella. Y en el Calvario la promesa se cumplió: la cabeza de la serpiente fue aplastada, aunque el talón de Cristo fue herido. Para Lutero, quien entiende Génesis 3:15 ha entendido el corazón de toda la Escritura: Dios en su gracia soberana remedió lo que el hombre destruyó.',
    libro: 'Génesis',
    obra: 'Vorlesungen über 1. Mose (Lectures on Genesis, 1535–1545)',
    url: 'https://www.gutenberg.org/ebooks/subject/Luther',
  },

  {
    ref: 'Salmos 46:1',
    titulo: 'Dios, nuestro amparo: inspiración de Un Castillo Fuerte',
    texto: 'El Salmo 46 fue el salmo favorito de Lutero —llamaba a este salmo "mi salmo"— y fue la inspiración directa de su himno "Ein feste Burg ist unser Gott" (Un Castillo Fuerte es Nuestro Dios, 1529). "Dios es nuestro amparo y fortaleza, nuestro pronto auxilio en las tribulaciones." Lutero lo escribió en medio de la persecución, la amenaza imperial, las guerras de religión y la división de la Iglesia. La fortaleza que Lutero necesitaba no era un ejército o un príncipe poderoso —aunque los tuvo— sino la certeza de que Dios mismo era su baluarte. En su himno repite esta convicción: "el diablo puede rugir con gran furia, su poder no tiene igual... mas caerá derrotado, pues Cristo es nuestro señor". La confianza de Lutero no era ingenuidad sino fe probada: había sido excomulgado, amenazado de muerte, puesto fuera de la ley del Imperio. Y en todo ello había encontrado que el Dios del Salmo 46 era real.',
    libro: 'Salmos',
    obra: 'Operationes in Psalmos (1519–1521); himno "Ein feste Burg" (1529)',
    url: 'https://www.ccel.org/ccel/luther/works.html',
  },

  {
    ref: 'Salmos 130:3-4',
    titulo: 'De profundis: el perdón que produce temor reverente',
    texto: '"Si mirares a los pecados, oh Jah, ¿quién, oh Señor, podrá mantenerse? Pero en ti hay perdón, para que seas reverenciado." Lutero meditó profundamente en este salmo y lo catalogó entre los "paulinos salmos" junto al 32, 51 y 143. La lógica del versículo 4 es paradójica y gloriosa: el perdón de Dios produce temor, no presunción. El que realmente entiende que Dios perdona gratuitamente —no porque el pecador lo merece sino porque Dios es misericordioso— se llena de asombro y reverencia, no de ligereza. Lutero advierte contra dos errores opuestos: el de los que temen a Dios por sus pecados pero no conocen el perdón (escrúpulo sin evangelio) y el de los que "conocen" el perdón pero lo toman como patente para el descuido moral (libertinaje sin temor). El verdadero conocimiento del evangelio produce ambas cosas: paz con Dios y profunda reverencia ante su santidad y misericordia.',
    libro: 'Salmos',
  ...
  {
    ref: 'Mateo 4:4',
    titulo: 'No sólo de pan vivirá el hombre',
    texto: 'Cuando el diablo tentó a Jesús proponiéndole que convirtiera las piedras en pan, Jesús respondió con Deuteronomio 8:3: "No sólo de pan vivirá el hombre, sino de toda palabra que sale de la boca de Dios." Lutero veía en esta respuesta el modelo para toda tentación: la Escritura es la única arma eficaz contra el diablo. En "De la Libertad del Cristiano" desarrolla que el alma no vive de pan sino de la Palabra: el cuerpo puede ser privado de alimento, pero el alma que tiene la Palabra de Dios posee todo. Lutero también usó este texto contra la teología que subordinaba la Escritura a la tradición eclesiástica: la Palabra de Dios no necesita el permiso de ningún hombre para ser autoritativa. Y contra los que buscaban las reformas por vía política y militar: "yo he hecho solo lo siguiente: he predicado, escrito, enseñado la Palabra de Dios; lo demás lo hizo Dios."',
    libro: 'Mateo',
    obra: 'Sermones sobre Mateo; "Von der Freiheit eines Christenmenschen" (1520)',
    url: 'https://www.gutenberg.org/ebooks/author/Martin+Luther',
  },

  {
    ref: 'Juan 8:32',
    titulo: 'La verdad que libera: sola scriptura',
    texto: '"Y conoceréis la verdad, y la verdad os hará libres." Para Lutero este versículo resumía el principio de la Reforma: la verdad que libera es la Palabra de Dios, y esa Palabra es accesible a todo creyente, no solo a los clérigos o a los concilios. En la Dieta de Worms (1521), cuando se le exigió retractarse, respondió: "Mi conciencia está cautiva en la Palabra de Dios. Retractarme no puedo ni quiero, porque no es seguro actuar contra la conciencia. Aquí estoy; no puedo hacer otra cosa. Dios me ayude." La libertad cristiana que Lutero predicó no es libertad de la ley moral; es libertad del temor a la condenación, libertad de la tiranía de los hombres sobre la conciencia, libertad de la esclavitud de buscar la justicia por obras propias. Es la libertad del hijo en la casa del Padre.',
    libro: 'Juan',
    obra: 'Discurso en la Dieta de Worms (1521); "Von der Freiheit" (1520)',
    url: 'https://www.gutenberg.org/ebooks/author/Martin+Luther',
  },

  {
    ref: 'Romanos 1:17',
    titulo: 'La justicia de Dios: la gran revelación de la Reforma',
    texto: '"Porque en el evangelio la justicia de Dios se revela por fe y para fe; como está escrito: Mas el justo por la fe vivirá." Este versículo fue el versículo de la conversión de Lutero —el punto de inflexión de la Reforma entera. Lutero cuenta que durante años aborrecía la expresión "justicia de Dios", creyendo que era la justicia con la que Dios castiga a los pecadores. Entonces, en la "torre" del convento de Wittenberg, comprendió: la "justicia de Dios" en Romanos 1:17 no es la justicia que Dios exige sino la justicia que Dios da como don gratuito por la fe. "Me sentí como recién nacido y entré al paraíso por las puertas abiertas de par en par", escribió. Esta comprensión —la justificación por la fe sola— es el artículo por el que la Iglesia está de pie o cae (articulus stantis et cadentis ecclesiae). Sin esta doctrina no hay evangelio; con ella, todo lo demás se ordena.',
    libro: 'Romanos',
    obra: 'Prefacio a la Epístola a los Romanos (1522); autobiografía teológica (1545)',
    url: 'https://www.ccel.org/ccel/luther/romans_preface.html',
  },

  {
    ref: 'Romanos 3:23-24',
    titulo: 'Todos pecaron y son justificados gratuitamente',
    texto: '"Por cuanto todos pecaron, y están destituidos de la gloria de Dios, siendo justificados gratuitamente por su gracia, mediante la redención que es en Cristo Jesús." Lutero destaca la universalidad de la miseria ("todos pecaron") y la universalidad de la oferta ("justificados gratuitamente"). No hay distinción moral entre judío y griego, sacerdote y laico, monje y hombre del mundo: todos están en igual necesidad ante Dios. Y la justificación es "gratuitamente" —gratis, sin pago, sin mérito, sin condición previa en el hombre. En la Institución que Calvino construiría después encontramos la misma enseñanza, pero fue Lutero quien la redescubrió como el ruido de una explosión en el edificio de la teología medieval. La gracia gratuita no es una concesión a la debilidad moral; es la naturaleza misma del evangelio. Quitarle el "gratuitamente" es quitarle el evangelio.',
    libro: 'Romanos',
  ...
  {
    ref: 'Gálatas 2:16',
    titulo: 'Justificados por la fe, no por las obras de la ley',
    texto: '"Sabiendo que el hombre no es justificado por las obras de la ley, sino por la fe de Jesucristo." El Comentario a los Gálatas (1535) es la obra cumbre de Lutero: lo llamó "mi Catalina" (el nombre de su esposa) —lo que más amaba. Aquí desarrolla la distinción fundamental entre la ley y el evangelio. La ley muestra el pecado; el evangelio da la justicia. La ley exige; el evangelio promete. La ley dice "haz esto"; el evangelio dice "toma esto". El error del catolicismo medieval, según Lutero, era mezclar los dos: añadir obras a la fe, condiciones a la gracia. Pero si se añade cualquier obra humana como condición de la justificación, la gracia deja de ser gracia. El "solo" de la fe (sola fide) no está en la letra del texto pero sí en su espíritu: "justificados por la fe" excluye las obras como causa de la justificación.',
    libro: 'Gálatas',
  ...
  {
    ref: 'Gálatas 3:13',
    titulo: 'Cristo hecho maldición por nosotros',
    texto: '"Cristo nos redimió de la maldición de la ley, hecho por nosotros maldición." Este versículo contiene para Lutero el corazón de la expiación. Cristo no solo sufrió —sufrió en nuestro lugar, tomando sobre sí la maldición que nos pertenecía. Lutero describe esto con una imagen deslumbrante: como en el matrimonio el marido y la esposa comparten todo —la riqueza del uno se hace de la otra y las deudas de la otra se hacen del uno— así Cristo se unió a la humanidad por la fe y tomó todo el pecado de ella, dando a cambio toda su justicia. "El pecador más grande cargó al Inocente mayor; la deuda del hombre fue pagada por el Dios-Hombre." Esta sustitución es el corazón del evangelio: no un ejemplo de virtud sino un rescate real. El creyente que entiende esto no teme al juicio porque la maldición ya fue tomada, ya fue pagada, ya fue acabada.',
    libro: 'Gálatas',
    obra: 'Commentarius in Epistolam Pauli ad Galatas (1535)',
    url: 'https://www.ccel.org/ccel/luther/galatians.html',
  },
  ...
  {
    ref: 'Efesios 2:8-9',
    titulo: 'La gracia sola: no hay contribución humana',
    texto: 'Lutero ve en Efesios 2:8-9 la confirmación apostólica de lo que descubrió en Romanos: la salvación es pura gracia, recibida por fe sola, sin ninguna contribución de obras humanas. "No de vosotros, pues es don de Dios. No por obras, para que nadie se gloríe." El "no por obras" excluye toda actividad humana como causa de la salvación. La pregunta inevitable es: ¿entonces qué hago yo? Lutero responde: recibes. El mendigo que recibe pan del rey no contribuye al pan; contribuye la mano abierta. Y aun esa mano —la fe— es don de Dios. La gloria de la salvación pertenece enteramente a Dios. Esto era escandaloso para la teología medieval que había construido un sistema de méritos y satisfacciones. Para Lutero era liberador: ya no necesitaba ganarse a Dios; Dios le había dado todo gratuitamente.',
    libro: 'Efesios',
    obra: 'Der Große Katechismus (1529); sermones sobre Efesios',
    url: 'https://www.ccel.org/ccel/luther/largecatechism.html',
  },

  {
    ref: '1 Corintios 1:18',
    titulo: 'La locura de la cruz: sabiduría de Dios',
    texto: '"Porque la palabra de la cruz es locura a los que se pierden; pero a los que se salvan, esto es, a nosotros, es poder de Dios." Lutero desarrolló su famosa "teología de la cruz" (theologia crucis) contra la "teología de la gloria" (theologia gloriae). La teología de la gloria busca a Dios en el poder, el éxito, la razón y la gloria visible. La teología de la cruz lo encuentra donde Dios ha elegido revelarse: en lo débil, lo necio, lo despreciado, el sufrimiento y la cruz. La Reforma fue en parte un choque entre estas dos teologías: la Iglesia que buscaba el poder político y la gloria mundana, versus el evangelio que proclama un Rey coronado de espinas. Para Lutero el predicador no debe avergonzarse de la cruz ni "ennoblecer" el evangelio con filosofía humana: la palabra de la cruz, tal como es, es poder de Dios para los que se salvan.',
    libro: '1 Corintios',
    obra: 'Heidelberger Disputation (1518); sermones sobre 1 Corintios',
    url: 'https://www.ccel.org/ccel/luther/works.html',
  },

  {
    ref: 'Apocalipsis 12:11',
    titulo: 'Vencieron al acusador por la sangre del Cordero',
    texto: '"Y ellos le han vencido por medio de la sangre del Cordero y de la palabra del testimonio de ellos, y menospreciaron sus vidas hasta la muerte." Para Lutero, perseguido por la Iglesia y el Imperio, este versículo era sustento real, no solo promesa futura. Los mártires de la Reforma —quemados, ahogados, decapitados— vencieron no con espada sino con la sangre del Cordero y la palabra de su testimonio. Lutero meditó sobre los mártires anabautistas con quienes no coincidía teológicamente y escribió: "debo confesar que mueren con más valentía que muchos de los nuestros". La victoria del creyente en la tribulación no es la ausencia del sufrimiento sino la fidelidad hasta el fin. Y el fundamento de esa fidelidad es la sangre del Cordero: el creyente no se sostiene a sí mismo; es sostenido por la obra de Cristo. El acusador —el diablo— no puede vencer al que está cubierto por esa sangre.',
    libro: 'Apocalipsis',
    obra: 'Prefacio al Apocalipsis (1530); sermones varios',
    url: 'https://www.ccel.org/ccel/luther/works.html',
  },
