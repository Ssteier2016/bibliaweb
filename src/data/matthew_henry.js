// Comentarios bíblicos de Matthew Henry (1662–1714)
// Fuente principal: "Commentary on the Whole Bible" (6 vols., 1706–1714)
// Obra de dominio público — disponible en CCEL y Project Gutenberg

export const MATTHEW_HENRY_COMMENTARY = [

  {
    ref: 'Génesis 1:1',
    titulo: 'El universo creado por Dios, para Dios',
    texto: 'El primer versículo de la Escritura nos enseña lo que la razón sola nunca podría descubrir con certeza: que el mundo tuvo un principio y que Dios fue su autor. "En el principio" —así Moisés nos lleva de la mano hasta el umbral de la eternidad. No se dice nada antes de ese instante porque nada existía antes, excepto Dios mismo. "Creó Dios" —no simplemente ordenó o moldeó, sino creó: produjo de la nada todo lo que existe. Esto destruye dos errores: el de los que piensan que la materia es eterna y el de los que piensan que el mundo se hizo solo. La materia no se hizo a sí misma; Dios la hizo. El universo no es un producto del azar sino de la sabiduría y el poder soberanos. Toda la creación lleva impresa la marca de su Hacedor: orden, hermosura, propósito. El creyente que lee este versículo aprende desde el principio que vive en el mundo de Dios, creado para la gloria de Dios, y que su propia existencia no es accidental sino querida.',
    libro: 'Génesis',
    obra: 'Commentary on the Whole Bible, Vol. I — Génesis (1706)',
    url: 'https://www.ccel.org/ccel/henry/mhc1.Gen.ii.html',
  },

  {
    ref: 'Génesis 3:6',
    titulo: 'La caída: cómo entra el pecado',
    texto: 'Notemos el proceso de la tentación y la caída, pues el mismo proceso se repite en cada pecado humano. Primero Eva vio que el árbol era bueno para comer —el apetito fue despertado. Luego que era agradable a los ojos —la imaginación fue encendida. Finalmente que era deseable para alcanzar sabiduría —el orgullo fue halagado. Así el pecado siempre ataca: primero al sentido, luego a la emoción, finalmente a la voluntad. Eva no cayó en un instante; fue llevada paso a paso. Y tomó del fruto, y comió. Cuán breve la descripción; cuán terrible la realidad. En ese momento entró en el mundo la muerte, la tristeza, la vergüenza. Y luego dio también a su marido —el pecado rara vez se queda solo; el que cae busca compañía en la caída. Toda la historia humana posterior es el desarrollo de ese momento: el hombre que prefiere su voluntad a la de Dios. Y toda la historia de la salvación es la respuesta de Dios a ese momento: Uno que prefirió la voluntad de Dios a la suya propia.',
    libro: 'Génesis',
    obra: 'Commentary on the Whole Bible, Vol. I — Génesis (1706)',
    url: 'https://www.ccel.org/ccel/henry/mhc1.Gen.iv.html',
  },

  {
    ref: 'Salmos 23:1',
    titulo: 'Jehová es mi Pastor: nada me faltará',
    texto: 'En este salmo David describe la felicidad del creyente bajo la metáfora del pastor y la oveja. "Jehová es mi pastor" —esta es la primera declaración, y de ella fluyen todas las demás. Quien tiene a Jehová por Pastor tiene todo. La oveja no necesita buscar pastos: el Pastor la conduce. No necesita buscar agua: el Pastor la guía. No necesita temer al valle de sombra de muerte: el Pastor va con ella. No necesita temer a los enemigos: la vara y el cayado la defienden. No necesita temer al hambre: el Pastor prepara mesa en presencia de los adversarios. La deducción es inevitable: "nada me faltará." No dice "nada me faltará si tengo buena salud", ni "si tengo riquezas", ni "si tengo amigos". Dice "nada me faltará" porque tengo al Pastor. Quien tiene al Pastor tiene más que quien tiene todas las riquezas del mundo sin Él. Este salmo es el canto del alma satisfecha: no porque sus circunstancias sean perfectas, sino porque su Pastor es perfecto.',
    libro: 'Salmos',
    obra: 'Commentary on the Whole Bible, Vol. III — Salmos (1710)',
    url: 'https://www.ccel.org/ccel/henry/mhc3.Ps.xxiv.html',
  },

  {
    ref: 'Salmos 51:10',
    titulo: 'Crea en mí, oh Dios, un corazón limpio',
    texto: 'David había contaminado su corazón con el adulterio y el homicidio; ahora pide que ese mismo corazón sea recreado. "Crea en mí, oh Dios, un corazón limpio." Nótese la palabra "crea": el mismo término usado en Génesis para la creación original. No pide que el corazón viejo sea remendado, mejorado o lavado superficialmente; pide que sea creado de nuevo. Esta es la doctrina de la regeneración: no una reforma moral desde dentro, sino una nueva creación desde arriba. Solo Dios puede crear; solo Dios puede regenerar. El hombre puede cambiar su conducta; no puede cambiar su corazón. Por eso el arrepentimiento genuino no confía en las propias fuerzas sino que corre a Dios y dice: "Crea en mí." Y "renueva un espíritu recto dentro de mí" —la renovación del espíritu es continua; el creyente necesita cada día la gracia de Dios para mantener la integridad. La santificación no es un logro pasado sino una gracia presente y continua.',
    libro: 'Salmos',
    obra: 'Commentary on the Whole Bible, Vol. III — Salmos (1710)',
    url: 'https://www.ccel.org/ccel/henry/mhc3.Ps.lii.html',
  },

  {
    ref: 'Proverbios 3:5-6',
    titulo: 'Confiar en Dios con todo el corazón',
    texto: '"Fíate de Jehová de todo tu corazón, y no te apoyes en tu propia prudencia." Aquí está la suma de la sabiduría práctica. No dice que ignoremos la razón ni que no pensemos; dice que no nos APOYEMOS en ella como si fuera el fundamento último. La razón humana es un don de Dios, pero un don limitado y corrompido por la caída. El hombre que se apoya en su propio entendimiento como el ciego que apoya su bastón en una caña rota: la caña puede sostenerse un momento pero cederá cuando más se necesite. "Reconócelo en todos tus caminos" —en los grandes y en los pequeños, en los asuntos de la familia y en los del comercio, en las decisiones importantes y en las cotidianas. No hay área de vida donde Dios no sea relevante. "Y Él enderezará tus veredas" —la promesa es maravillosa: Dios no solo acompaña al que confía en Él; actúa providencialmente para guiar sus pasos. El hombre que confía en Dios no navega a ciegas; tiene al piloto que conoce todas las aguas.',
    libro: 'Proverbios',
    obra: 'Commentary on the Whole Bible, Vol. III — Proverbios (1710)',
    url: 'https://www.ccel.org/ccel/henry/mhc3.Pro.iv.html',
  },

  {
    ref: 'Isaías 53:4-5',
    titulo: 'El siervo sufriente: sustitución y expiación',
    texto: 'Isaías 53 es el corazón del evangelio en el Antiguo Testamento. "Ciertamente llevó Él nuestras enfermedades, y sufrió nuestros dolores." El énfasis está en el "nuestros": no dolores propios sino ajenos. El Siervo carga con lo que no es suyo para dar a cambio lo que no es nuestro. "Fue herido por nuestras rebeliones, molido por nuestros pecados." Cuatro expresiones se acumulan para que ningún lector se equivoque: herido, molido, castigo, llagas —todo causado por "nuestras rebeliones", "nuestros pecados", "nuestro castigo", "nuestras enfermedades". La culpa es nuestra; el sufrimiento fue de Él. Esta es la doctrina de la sustitución penal, clara y luminosa, siglos antes del Calvario. Y la conclusión: "por su llaga fuimos nosotros curados." No por nuestra penitencia, no por nuestros esfuerzos, no por nuestra mejora moral. Por Su llaga. El evangelio no dice: "esfuérzate y serás curado". Dice: "por Su llaga fuiste curado". El creyente descansa en lo que Cristo hizo, no en lo que él hace.',
    libro: 'Isaías',
    obra: 'Commentary on the Whole Bible, Vol. IV — Isaías (1712)',
    url: 'https://www.ccel.org/ccel/henry/mhc4.Isa.liv.html',
  },

  {
    ref: 'Mateo 5:3',
    titulo: 'Bienaventurados los pobres en espíritu',
    texto: 'El Sermón del Monte comienza donde toda la religión verdadera debe comenzar: con el reconocimiento de la pobreza espiritual. "Bienaventurados los pobres en espíritu" —no los orgullosos, no los autosuficientes, no los que se creen ricos en virtud. Los pobres en espíritu son los que conocen su propia indigencia ante Dios: que no tienen justicia propia que presentar, que no tienen méritos que alegar, que están en bancarrota espiritual y lo saben. Esta pobreza no es la desesperación sino el punto de partida de la gracia. Solo el que sabe que es pobre busca al que puede enriquecerle. Solo el que conoce su enfermedad busca al médico. "De ellos es el reino de los cielos" —qué herencia tan desproporcionada. Los que nada tienen reciben todo. Los que nada son reciben el reino. Esta es la lógica del evangelio: Dios da lo infinito a los que se confiesan nada. La beatitud no está en el éxito, la riqueza o la salud; está en conocer a Dios y ser conocido de Él.',
    libro: 'Mateo',
    obra: 'Commentary on the Whole Bible, Vol. V — Mateo (1714)',
    url: 'https://www.ccel.org/ccel/henry/mhc5.Mat.vi.html',
  },

  {
    ref: 'Juan 3:16',
    titulo: 'El amor de Dios al mundo: el corazón del evangelio',
    texto: 'Este versículo contiene el evangelio completo en sus partes esenciales. "Porque de tal manera amó Dios al mundo" —el origen de la salvación es el amor soberano de Dios, no el mérito del hombre. Dios amó primero, cuando no había razón en nosotros para ser amados. "Que ha dado a su Hijo unigénito" —el don es proporcional al amor. Dios no dio oro ni plata ni ángeles ni profetas; dio a su Hijo unigénito, la persona más preciosa que posee. "Para que todo aquel que en Él cree" —la condición es la fe, no las obras, no la perfección moral, no la nobleza de nacimiento. "No se pierda, mas tenga vida eterna" —dos movimientos: escapar de la perdición y obtener la vida. La salvación es positiva y negativa: libera DE y conduce A. El que cree en Cristo no tiene que temer la perdición; tiene todo el derecho de esperar la vida eterna. Este versículo no es solo para los teólogos; es para cualquier alma que oiga el evangelio y se pregunte: ¿Puede Dios salvarme a mí? La respuesta es este versículo.',
    libro: 'Juan',
    obra: 'Commentary on the Whole Bible, Vol. V — Juan (1714)',
    url: 'https://www.ccel.org/ccel/henry/mhc5.Joh.iv.html',
  },

  {
    ref: 'Romanos 8:28',
    titulo: 'Todas las cosas obran para bien',
    texto: '"Y sabemos que a los que aman a Dios, todas las cosas les ayudan a bien." Esta es la provisión más consoladora de las Escrituras para el creyente en medio de la tribulación. Nótese que dice "todas las cosas", no "las cosas agradables" ni "las cosas fáciles" ni "las cosas que entendemos". Todas las cosas: las enfermedades, las pérdidas, las traiciones, los fracasos, las muertes de seres queridos. La providencia de Dios no trabaja solo con material bueno; trabaja con todo, incluso con el mal, para producir bien en los que ama. "A los que aman a Dios" —esta promesa no es universal; es para los que aman a Dios, es decir, para los llamados según su propósito. No es fatalismo ni optimismo ingenuo; es confianza en el Dios soberano que no pierde el hilo de ninguna historia. El creyente que lee este versículo puede mirar al pasado con gratitud, al presente con paz y al futuro con esperanza, porque Dios está trabajando en todo, siempre, para bien de los suyos.',
    libro: 'Romanos',
    obra: 'Commentary on the Whole Bible, Vol. VI — Romanos (1714)',
    url: 'https://www.ccel.org/ccel/henry/mhc6.Rom.ix.html',
  },

  {
    ref: 'Efesios 2:8-9',
    titulo: 'Salvados por gracia mediante la fe, no de obras',
    texto: '"Porque por gracia sois salvos por medio de la fe; y esto no de vosotros, pues es don de Dios. No por obras, para que nadie se gloríe." Aquí Pablo sella la puerta a toda jactancia humana en la salvación. La gracia es el fundamento: la iniciativa libre y no merecida de Dios. La fe es el medio: no la causa que merece la salvación sino la mano que la recibe. "Y esto no de vosotros" —tanto la gracia como la fe misma son dones de Dios. El hombre no se salva ni por sus méritos ni por su propia decisión autónoma de creer; todo es don. "No por obras, para que nadie se gloríe" —Dios ha diseñado la salvación de tal manera que excluye toda vanagloria humana. Si hubiera cualquier contribución humana, habría terreno para la soberbia. Pero la salvación es pura gracia, y por tanto toda la gloria pertenece solo a Dios. El creyente que entiende esto no canta "cuánto he hecho por Dios", sino "cuánto ha hecho Dios por mí", y esa es la melodía del cielo.',
    libro: 'Efesios',
    obra: 'Commentary on the Whole Bible, Vol. VI — Efesios (1714)',
    url: 'https://www.ccel.org/ccel/henry/mhc6.Eph.iii.html',
  },

  {
    ref: 'Filipenses 4:6-7',
    titulo: 'El antídoto divino para la ansiedad',
    texto: '"Por nada estéis afanosos, sino sean conocidas vuestras peticiones delante de Dios en toda oración y ruego, con acción de gracias." La ansiedad es el pecado del que desconfía de la providencia de Dios; la oración es la respuesta divina a esa ansiedad. Pablo no dice "no os pase nada difícil"; dice "no estéis afanosos por nada". La diferencia está en el corazón, no en las circunstancias. El remedio no es la filosofía estoica ni la negación de los problemas; es llevar los problemas a Dios en oración. "En toda oración y ruego, con acción de gracias" —la acción de gracias no es opcional; es parte de la oración genuina. El que ora sin agradecer no ha entendido todavía que Dios ya ha dado todo en Cristo. Y la promesa: "la paz de Dios, que sobrepasa todo entendimiento, guardará vuestros corazones." Esta paz no depende de que los problemas se resuelvan; depende de que Dios recibe la carga. El corazón que ora es un corazón custodiado por la paz de Dios.',
    libro: 'Filipenses',
    obra: 'Commentary on the Whole Bible, Vol. VI — Filipenses (1714)',
    url: 'https://www.ccel.org/ccel/henry/mhc6.Phi.v.html',
  },

  {
    ref: 'Hebreos 11:1',
    titulo: 'La fe: la sustancia de lo que se espera',
    texto: '"Es pues la fe la certeza de lo que se espera, la convicción de lo que no se ve." Esta definición apostólica de la fe es la más precisa que existe. La fe no es credulidad ciega; es "certeza" —hypostasis, la sustancia real de una cosa. La fe da realidad presente a las promesas futuras: el creyente no espera el cielo como el especulador espera su inversión, sino como el heredero espera la herencia que ya le pertenece. "La convicción de lo que no se ve" —la fe funciona donde los sentidos no alcanzan. No niega los sentidos, pero tampoco se limita a ellos. El creyente sabe que hay más realidad en lo invisible que en lo visible, porque lo visible es temporal y lo invisible es eterno. Los héroes de la fe del capítulo 11 no vivieron para ver las promesas cumplidas, pero murieron confiando en ellas como si ya las tuviesen. Esa es la naturaleza de la fe bíblica: no la ausencia de incertidumbre, sino la certeza de Dios que supera toda incertidumbre.',
    libro: 'Hebreos',
    obra: 'Commentary on the Whole Bible, Vol. VI — Hebreos (1714)',
    url: 'https://www.ccel.org/ccel/henry/mhc6.Heb.xii.html',
  },

  {
    ref: 'Santiago 1:2-4',
    titulo: 'El propósito divino de las pruebas',
    texto: '"Tened por sumo gozo, hermanos míos, cuando os halléis en diversas pruebas." Esta exhortación parece paradójica hasta que se entiende el propósito de las pruebas. Santiago no dice que las pruebas sean agradables en sí mismas, ni que debamos fingir que lo son. Dice que las tengamos por gozo porque su resultado —cuando son recibidas con fe— es incomparable. "La prueba de vuestra fe produce paciencia." La fe no probada es fe no desarrollada. El músculo que nunca se ejercita permanece débil. Del mismo modo, la fe que nunca es probada permanece inmadura. Dios permite las pruebas no como castigo sino como ejercicio espiritual. "Y la paciencia ha de tener su obra completa, para que seáis perfectos y cabales, sin que os falte cosa alguna." El objetivo de Dios en las pruebas es la madurez integral del creyente. El creyente maduro no es el que no ha sufrido, sino el que ha sufrido y ha encontrado a Dios fiel en el sufrimiento.',
    libro: 'Santiago',
    obra: 'Commentary on the Whole Bible, Vol. VI — Santiago (1714)',
    url: 'https://www.ccel.org/ccel/henry/mhc6.Jas.ii.html',
  },

  {
    ref: '1 Pedro 5:7',
    titulo: 'Echando toda vuestra ansiedad sobre Él',
    texto: '"Echando toda vuestra ansiedad sobre Él, porque Él tiene cuidado de vosotros." El verbo "echar" es enérgico: no guardar la ansiedad dentro, no llevarla a medias, sino lanzarla completamente sobre Dios. El creyente está invitado a deshacerse de la carga que aplasta, poniéndola sobre el que puede cargarla infinitamente. "Toda vuestra ansiedad" —no parte de ella, no las ansiedades que parecen dignas de ser llevadas a Dios, sino todas: las grandes y las pequeñas, las espirituales y las materiales, las de hoy y las de mañana. La razón es tan hermosa como poderosa: "porque Él tiene cuidado de vosotros." No es una religión de indiferencia cósmica donde el hombre es solo un átomo en el universo. Es la religión del Dios que cuida personalmente a cada uno de sus hijos. El que formó los cielos y la tierra tiene tiempo, atención e interés por cada uno de los que le pertenecen. El creyente que entiende esto no acumula ansiedades; las echa sobre el Padre que ya las conocía todas antes de que él las sintiera.',
    libro: '1 Pedro',
    obra: 'Commentary on the Whole Bible, Vol. VI — 1 Pedro (1714)',
