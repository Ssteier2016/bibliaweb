...
const AUTHORS = [
  ...
  },
  {
    ...
    years: '1714–1770',
    tradition: 'Anglicana Evangélica · Gran Despertar · Predicación al Aire Libre',
    bio: 'Clérigo anglicano inglés, uno de los predicadores más influyentes del Gran Despertar en Gran Bretaña y las Trece Colonias americanas. Pionero de la predicación al aire libre ante multitudes de miles de personas. Célebre por su insistencia en la necesidad del nuevo nacimiento ("ye must be born again"). Sus sermones y diarios son dominio público.',
